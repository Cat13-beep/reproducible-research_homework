...
5e) I can use the predicted values of alpha and beta from my answer to 5c to predict the volume of a virion with a genomic size of 300kb for a double-stranded DNA virus. As discussed above my values are the same as that of the double-stranded DNA values in the table so I can be confident in my estimated answer with my values for alpha and beta- input into the equation V=aL^b which is 1181.807 * 300^1.5152= a viral volume of 6.697*10^6 nm^3.
