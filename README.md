...
My values are, however, identical to the number of significant figures the table holds for double-stranded DNA viruses- so the viruses in the table are likely this type of classification of virus.
